...
def test_minter_dois(app, create_record_factory):
...
def test_minter_dois_duplicate(app, create_record_factory):
    doi_value_1 = faker.doi()
    data = {
        "dois": [
...
def test_minter_dois_empty(app, create_record_factory):
...
def test_mitner_dois_already_existing(app, create_record_factory):
    doi_value = faker.doi()
...
def test_mitner_dois_missing_schema(app, create_record_factory):
    doi_value = faker.doi()
    data = {"dois": [{"value": doi_value}]}
