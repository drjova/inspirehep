...
def test_minter_arxiv_eprints(app, create_record_factory):
...
def test_minter_arxiv_eprints_empty(app, create_record_factory):
...
def test_minter_arxiv_eprints_duplicate(app, create_record_factory):
    arxiv_value_1 = faker.arxiv()
    data = {
        "arxiv_eprints": [
...
def test_mitner_arxiv_eprints_already_existing(app, create_record_factory):
...
def test_mitner_arxiv_eprints_missing_schema(app, create_record_factory):
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}]}
