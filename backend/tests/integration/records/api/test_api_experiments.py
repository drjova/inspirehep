...
def test_experiments_create(app):
...
def test_experiments_update(app):
    data = faker.record("exp", with_control_number=True)
    record = ExperimentsRecord.create(data)
...
def test_experiments_create_or_update_with_new_record(app):
    data = faker.record("exp")
...
def test_experiments_create_or_update_with_existing_record(app):
    data = faker.record("exp", with_control_number=True)
    record = ExperimentsRecord.create(data)
