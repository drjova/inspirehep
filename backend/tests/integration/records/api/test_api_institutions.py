...
def test_institutions_create(app):
...
def test_institutions_update(app):
    data = faker.record("ins", with_control_number=True)
    record = InstitutionsRecord.create(data)
...
def test_institutions_create_or_update_with_new_record(app):
    data = faker.record("ins")
...
def test_institutions_create_or_update_with_existing_record(app):
    data = faker.record("ins", with_control_number=True)
    record = InstitutionsRecord.create(data)
