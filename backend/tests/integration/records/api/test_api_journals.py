...
def test_journals_create_or_update_with_new_record(app):
    data = faker.record("jou")
...
def test_journals_create_or_update_with_existing_record(app):
    data = faker.record("jou", with_control_number=True)
    record = JournalsRecord.create(data)
