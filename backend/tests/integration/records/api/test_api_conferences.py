...
def test_conferences_create(app):
...
def test_conferences_update(app):
    data = faker.record("con", with_control_number=True)
    record = ConferencesRecord.create(data)
...
def test_conferences_create_or_update_with_new_record(app):
    data = faker.record("con")
...
def test_conferences_create_or_update_with_existing_record(app):
    data = faker.record("con", with_control_number=True)
    record = ConferencesRecord.create(data)
