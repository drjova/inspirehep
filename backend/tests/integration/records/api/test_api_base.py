...
def test_base_get_record(app, create_record_factory):
...
def test_base_get_records(app, create_record_factory):
    records = [
...
def test_get_uuid_from_pid_value(app, create_record_factory):
    record = create_record_factory("lit")
...
def test_get_records_by_pids(app, create_record_factory):
    records = [
        create_record_factory("lit"),
        create_record_factory("lit"),
        create_record_factory("lit"),
...
def test_get_records_by_pids_with_empty(app, create_record_factory):
    pids = []
...
def test_get_linked_records_in_field(app, create_record_factory):
...
def test_get_linked_records_in_field_empty(app, create_record_factory):
    expected_result_len = 0
    expected_result = []
...
def test_create_record_throws_exception_if_wrong_subclass_used(app):
