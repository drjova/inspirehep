...
class LiteratureRecord(
    ...
    def create(
        ...
        **kwargs,
        ...
        cls.update_authors_signature_blocks_and_uuids(data)
        cls.update_refs_to_conferences(data)
        data = cls.add_files(data)
    ...
    def update(
        ...
        **kwargs,
        ...
        with db.session.begin_nested():
            self.update_authors_signature_blocks_and_uuids(data)
            self.update_refs_to_conferences(data)
