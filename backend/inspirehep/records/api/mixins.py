...
class CitationMixin(PapersAuthorsExtensionMixin):
    ...
    # @classmethod
    # def create(cls, data, disable_relations_update=False, *args, **kwargs):
    #     record = super().create(data, disable_relations_update, *args, **kwargs)
...
class ExperimentPapersMixin:
    ...
    # def create(cls, data, disable_relations_update=False, *args, **kwargs):
    #     record = cls()
    #     super().create(data, disable_relations_update, *args, **kwargs)
    #     if not disable_relations_update:
